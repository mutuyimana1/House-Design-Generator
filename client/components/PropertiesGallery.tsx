    ...
    <section className="w-full bg-white py-12 md:py-20">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[110px]">
        ...
        <div className="flex justify-end mt-8">
          <button
            onClick={() => navigate("/latest-designs")}
            className="flex items-center gap-2 bg-navy text-white text-[13px] font-normal rounded-full pl-4 pr-6 py-2 hover:bg-navy/80 transition-colors"
          >
